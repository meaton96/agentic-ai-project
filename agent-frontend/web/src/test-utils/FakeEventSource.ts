...
// SSE support at all. Tests install this via `vi.stubGlobal('EventSource',
// FakeEventSource)`, then grab the created instance to `.emit(...)` a
// scripted event sequence and assert on how the app reacts, without any
// real network/server involved.
